    ...
    <div ref={wrapRef} className="w-full bg-white rounded-2xl border border-gray-200 overflow-hidden relative">
      ...
      {!focusedLabel && (
        <div className="absolute bottom-3 right-3 group">
          ...
          <div className="absolute bottom-full right-0 mb-2 hidden group-hover:block bg-white border border-gray-200 rounded-xl shadow-lg px-3 py-2.5 min-w-[180px]">
          ...
          <div className="flex items-center gap-1.5 bg-white/90 backdrop-blur-sm border border-gray-200 rounded-full px-3 py-1.5 shadow-sm cursor-default">
            ...
            <span className="text-xs text-gray-400">scroll · drag</span>
          </div>
        </div>
      )}
    </div>
